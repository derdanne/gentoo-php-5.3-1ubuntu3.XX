...
# $Header: /var/cvsroot/gentoo-x86/dev-lang/php/php-5.3.29.ebuild,v 1.13 2014/12/28 15:27:17 titanofold Exp $
...
PHP_SRC_URI="https://launchpad.net/ubuntu/+archive/primary/+files/php5_5.3.10.orig.tar.gz"
...
src_prepare() {
	...
	epatch "${FILESDIR}"/php5_5.3.10-1ubuntu3.21.patch
